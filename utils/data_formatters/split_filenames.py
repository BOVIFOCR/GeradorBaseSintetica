...
if mode == "cross":
    ...
    train = [synth_fname for orig_fname in train_idx for synth_fname in fs[orig_fname]]
    valid = [synth_fname for orig_fname in valid_idx for synth_fname in fs[orig_fname]]
    test = [synth_fname for orig_fname in test_idx for synth_fname in fs[orig_fname]]
